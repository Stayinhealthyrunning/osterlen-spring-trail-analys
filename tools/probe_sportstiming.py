...
def main():
    ...
    for ev in EVENTS:
        ...
        for p in PATHS:
            ...
            rows.append({'year':ev['year'],'event_id':ev['event_id'],'path':p,'url':url,'http_status':status,'final_url':final,**summarize(body)})
